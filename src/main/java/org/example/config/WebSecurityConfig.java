...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public UserDetailsServiceImpl userDetailsService(UserRepo userRepository) {
...
//    }
    ...
    public CorsFilter corsFilter() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:4200", "https://payroll.tnhb.in", "https://employee-corner.tnhb.in"));
        config.setAllowedHeaders(Arrays.asList("Origin", "Content-Type", "Accept"));
